      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form id="userForm" method="post">
               ...
               <input type="hidden" id="test_id" value="<?=$EDITDATA[0]->id ?>">
               <input type="hidden" id="test_name" value="<?=$EDITDATA[0]->name ?>">
               <input type="hidden" id="amount" value="<?=$EDITDATA[0]->amount ?>">
               <button type="button" class="btn btn-success w-100 withdraw-submit-btn">
               Submit
               </button>
            </form>
         </div>
...
<script>
 ...
 /*withdraw request*/
    ...
    function book_request()
    {
        ...
        form.append("select_time", select_time);
        form.append("test_id", test_id);
        form.append("test_name", test_name);
        form.append("amount", amount);

        var settings = {
          "url": "<?=base_url() ?>welcome/booknow",
          "method": "POST",
          "dataType": "json",
          "timeout": 0,
          "processData": false,
