<!-- Footer Start -->
            ...
            <div class="d-flex flex-column justify-content-start">
              <a class="text-light mb-2" href="<?=base_url() ?>"
               ...
               <a class="text-light mb-2" href="<?=base_url() ?>about"
                  ...
                  >
               <a class="text-light mb-2" href="<?=base_url() ?>our-packages"
                  ><i class="fa fa-angle-right me-2"></i>Health Packages</a
                  >
               <a class="text-light mb-2" href="<?=base_url() ?>blog"
                  ><i class="fa fa-angle-right me-2"></i>Latest Blog</a
                  >
               <a class="text-light mb-2" href="<?=base_url() ?>contact"
    ...
    >
      ...
      <a id="whatsapp" href="https://api.whatsapp.com/send?phone=+918851054064&amp;text=hii ..."><img class="heart" src="<?=base_url() ?>img/what.png" style="position: fixed;z-index: 99999;bottom: 90px; left: 14px; width: 60px;"></a>
                <a href="tel:+918851054064"><img class="heart" src="<?=base_url() ?>img/call.png" style="position: fixed;z-index: 99999;bottom: 10px; left:15px; width: 60px;"></a>
    </div>
    <!-- Footer End -->
