...
public function login()
{
    if (isset($_POST['submit'])) {
        ...
        $this->db->where("(email = '$identifier' OR mobile = '$identifier')", NULL, FALSE);
        ...
        if ($query->num_rows() == 1) 
        {
            ...
            $this->session->set_flashdata('login_msg', '<div class="alert alert-danger">Wrong Email/Mobile Or Password.</div>');
