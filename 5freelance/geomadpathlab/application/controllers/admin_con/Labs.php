...
class Labs extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Labs',
						   	'table_name'=>'labs',
						   	'upload_path'=>'media/uploads/labs/',
						   	'load_path'=>'admin/labs/',
						   	'redirect_path'=>'admin_con/labs/',
						   	'back_url'=>'labs',
						   	'add_url'=>'labs',
						   	'edit_url'=>'labs',
						   	'delete_url'=>'labs',
						   	'view_url'=>'labs',
						   	'table_url'=>'admin/labs/table',
						   	'status_value'=>'labs',
						   	'multiple_delete'=>'admin_con/labs/delete_all',
						   	'pagination_url'=>'admin_con/labs/get_table_data',
						   	'controller_name'=>'labs',
						   	'page_name'=>'lab-inner.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$bottomcontent = $this->input->post('bottomcontent');
