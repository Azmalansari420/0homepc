                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-6 form-group">
                           ...
                           <input type="text" class="form-control" name="countername" value="<?=$EDITDATA[0]->countername ?>" required>
                        </div>
                        ...
                        <div class="col-12 form-group">
                           <label>Content </label>
                           <textarea name="location" class="summernote form-control"><?=$EDITDATA[0]->location ?></textarea>
                        </div>
                     </div>
                  </div>
               </div>
