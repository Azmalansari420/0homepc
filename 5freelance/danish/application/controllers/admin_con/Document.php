...
class Document extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Document',
						   	'table_name'=>'document',
						   	'upload_path'=>'media/uploads/document/',
						   	'load_path'=>'admin/document/',
						   	'redirect_path'=>'admin_con/document/',
						   	'back_url'=>'document',
						   	'add_url'=>'document',
						   	'edit_url'=>'document',
						   	'delete_url'=>'document',
						   	'view_url'=>'document',
						   	'table_url'=>'admin/document/table',
						   	'status_value'=>'document',
						   	'multiple_delete'=>'admin_con/document/delete_all',
						   	'pagination_url'=>'admin_con/document/get_table_data',
						   	'controller_name'=>'document',
						   	'page_name'=>'document.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	public function get_table_data() 
	{
	  ...
	  $this->db->or_like('countername', $search);
