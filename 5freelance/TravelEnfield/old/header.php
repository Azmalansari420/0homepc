            ...
            <div class="main-menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item-has-children active">
                        ...
                        <ul class="sub-menu">
                            <li><a href="group-trips-list.php">✈️ International Trips</a></li>
                            <li><a href="group-trips-list.php">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <i class="bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href="deals-trips-list.php">🔥 Northern Lights Early Bird</a></li>
                        </ul>
                    </li>  
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <i class="bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href="">🏍️ Bike Trips</a></li>
                            <li><a href="">🛕 Spiritual Trips</a></li>
                            <li><a href="">💌 The Match Maker</a></li>
                            <li><a href="">🧘🏻 Wellness Retreats</a></li>
                            <li><a href="">⛰️ Treks</a></li>
                        </ul>
                    </li>                   

                    <li><a href="">🧳 Upcoming Group Trips</a></li>
                    <li><a href="">🚗 Weekend Trip</a></li>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <i class="bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href="">✈️ International Trips</a></li>
                            <li><a href=""> 
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" width="20" height="20">
                                  <rect width="3" height="0.67" y="0" fill="#FF9933"/>
                                  <rect width="3" height="0.66" y="0.67" fill="#FFFFFF"/>
                    ...
                    <li class="menu-item-has-children">
                        <a href="" class="drop-down">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16" fill="none">
                              <circle cx="8" cy="8" r="8" fill="#008342"/>
                              <path fill="#FCFFF7" d="M10.74 8.95c-.04.01-.08.02-.12.03-.19.06-.38.11-.57.15-.12.02-.24.04-.36.02-.06-.01-.12-.02-.18-.06-.04-.03-.04-.08-.05-.12l-.08-.26-.06-.19c-.01-.04.01-.07.05-.08.06-.02.1.01.14.05l.23.22c.03.03.06.04.1.03l.33-.1.37-.11.3-.09.24-.07.25-.07.25-.08.41-.12c.07-.02.14-.02.21 0 .1.02.19.06.26.13.02.01.03.03.04.05.02.04.01.06-.02.08-.09.05-.18.09-.28.13l-.29.11-.29.1-.29.1c-.01 0-.02.01-.03.02l-.14.23-.12.19c-.09.14-.18.28-.26.42-.04.06-.08.12-.13.18-.04.05-.1.07-.16.08h-.02c-.01 0-.03 0-.03-.01-.01-.01-.01-.03 0-.04l.11-.34.17-.52.17-.52v-.04Z"/>
                            </svg> More about us
                            <i class="bi bi-caret-down-fill"></i>
                        </a>
                        <i class="bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href=""> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16" fill="none">
                              <circle cx="8" cy="8" r="8" fill="#008342"/>
                              <path fill="#FCFFF7" d="M10.74 8.95c-.04.01-.08.02-.12.03-.19.06-.38.11-.57.15-.12.02-.24.04-.36.02-.06-.01-.12-.02-.18-.06-.04-.03-.04-.08-.05-.12l-.08-.26-.06-.19c-.01-.04.01-.07.05-.08.06-.02.1.01.14.05l.23.22c.03.03.06.04.1.03l.33-.1.37-.11.3-.09.24-.07.25-.07.25-.08.41-.12c.07-.02.14-.02.21 0 .1.02.19.06.26.13.02.01.03.03.04.05.02.04.01.06-.02.08-.09.05-.18.09-.28.13l-.29.11-.29.1-.29.1c-.01 0-.02.01-.03.02l-.14.23-.12.19c-.09.14-.18.28-.26.42-.04.06-.08.12-.13.18-.04.05-.1.07-.16.08h-.02c-.01 0-.03 0-.03-.01-.01-.01-.01-.03 0-.04l.11-.34.17-.52.17-.52v-.04Z"/>
                            </svg> About Us</a></li>
