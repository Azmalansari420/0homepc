<?php include('header.php'); ?>
    ...
    <section>
        <div>
            <img src="assets/Untitled design (7) (1).png" class="img-fluid">
        </div>
    </section>
    ...
    <div class="home1-destination-section mb-50 mt-50">
        <div class="container">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <!-- HTML -->
                <div class="tab-pane fade show active" id="pills-europe" role="tabpanel">
                    <!-- TOP CIRCLE SLIDER -->
                    <div class="swiper topCircleSlider mb-4">
                        <div class="swiper-wrapper">

                            <div class="swiper-slide">
                                <a href="">
                                    <div class="circle-box">
                                        <img src="assets/img/home1/destination-img1.jpg">
                                        <h6>Spain</h6>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="circle-box">
                                    <img src="assets/img/home1/destination-img2.jpg">
                                    <h6>Japan</h6>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="circle-box">
                                    <img src="assets/img/home1/destination-img3.jpg">
                                    <h6>Vietnam</h6>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="circle-box">
                                    <img src="assets/img/home1/destination-img4.jpg">
                                    <h6>Bali</h6>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="circle-box">
                                    <img src="assets/img/home1/destination-img5.jpg">
                                    <h6>Thailand</h6>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="circle-box">
                                    <img src="assets/img/home1/destination-img6.jpg">
                                    <h6>Nepal</h6>
                                </div>
                            </div>
                            <div class="swiper-slide">
                    ...
                    <div class="swiper bottomCircleSlider">
                        <div class="swiper-wrapper">
    ...
    <section>
        <div>
            <img src="assets/Untitled design (6) (1).png" class="img-fluid">
        </div>
    </section>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
             ...
             <div class="carousel-inner">
                <div class="carousel-item active">
                   <img src="assets/Untitled design (8) (1).png" class="d-block w-100" alt="..." style="border-radius: 15px;">
                </div>
...
<script>
/* TOP */
var topSlider = new Swiper(".topCircleSlider", {
    slidesPerView:8,
    spaceBetween:20,
    freeMode:true,
...
/* BOTTOM */
var bottomSlider = new Swiper(".bottomCircleSlider", {
    slidesPerView:8,
    spaceBetween:20,
    freeMode:true,
    watchSlidesProgress:true,
