		...
		<div class="row align-items-center">
			<div class="col-lg-7 col-md-6">
				<div class="slider-content">
					<h3>  A place that does what is necessary. </h3>
					<h1> Accounting, Tax, and </h1>
					<h1> Legal Consultancy <span>WOORILEX</span>  </h1>
					<p>A full-service firm of Chartered Accountants & Lawyers delivering world-class tax, legal, and compliance solutions for Korean companies operating in India.</p>
				</div>
				...
				<div class="banner-buttons">
					<div class="slider-button">
						<a href="service.html">
							Explore Services <i class="bi bi-plus"></i>
						</a>
					</div>

					<div class="slider-contact-box">
						<a class="contact-icon" href="tel:+919876543210">
			...
			<div class="col-lg-5 col-md-6">
				<div class="slider-thumb">
					<img src="https://legaldev.in/assets/img/normal/team-discussion.webp" alt="CA and Legal Services">
				</div>
