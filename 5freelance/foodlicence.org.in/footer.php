    ...
    <footer class="container-fluid bg-dark text-light footer mt-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container pt-5 pb-3">
            <div class="row g-5">
                ...
                <div class="col-lg-12 ">
                    <p>Disclaimer: Invenix India Financial Technologies Pvt Ltd is a private consultancy and compliance service provider and is not affiliated with, authorized by, endorsed by, or associated with the Food Safety and Standards Authority of India (FSSAI) or any other government authority. We do not issue any government licenses, registrations, or certificates. We charge a professional fee for application preparation, documentation, filing assistance, and advisory services. Applicants may also apply directly through the official FSSAI portal without availing our services. For official applications and information, please visit the FOSCOS portal at https://foscos.fssai.gov.in.</p>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>We are a Private Consultancy Service Provider. Not affiliated with FSSAI or any Government Authority.</p>
...
<script>
   ...
   /*--------------daily unit-------------*/
     ...
     $('.prodcution-radio').on('change', function () {
        $('.dairy-year-display').hide();
        $('.dairy-year-display-2').hide();
        $('.dairy-year-display-3').hide();
        $('.dairy-year-display-4').hide();

        var value = $(this).val();

        if (value == 'More than 50,000 Liters of Milk per day') {

            $('.dairy-year-display').show();

        } else if (value == '10001 – 50,000 Ltrs of Milk per day') {

            $('.dairy-year-display-2').show();

        } else if (value == '501 – 10,000 Ltrs of Milk per day') {

            $('.dairy-year-display-3').show();
        } else if (value == 'Upto 500 Ltrs of Milk per day') {

            $('.dairy-year-display-4').show();
        }
    });
   ...
   $('.vegitable-radio').on('change', function () {
        $('.vegitable-year-display').hide();
        $('.vegitable-year-display-2').hide();
        $('.vegitable-year-display-3').hide();
        $('.vegitable-year-display-4').hide();

        var value = $(this).val();

        if (value == 'More than 2 MT per day') {

            $('.vegitable-year-display').show();

        } else if (value == '1-2 MT per day') {

            $('.vegitable-year-display-2').show();

        } else if (value == 'Below 1 MT per day') {

            $('.vegitable-year-display-3').show();
        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.vegitable-year-display-4').show();
        }
    });   
   ...
   /*--------------slaughtering-------------*/
    ...
    $('.slaughtering-radio').on('change', function () {
        $('.slaughtering-year-display').hide();
        $('.slaughtering-year-display-2').hide();
        $('.slaughtering-year-display-3').hide();
        $('.slaughtering-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Large Animals: More than 50') {

            $('.slaughtering-year-display').show();

        } else if (value == 'Large Animals: 3 to 50') {

            $('.slaughtering-year-display-2').show();

        } else if (value == 'Large Animals: 2') {

            $('.slaughtering-year-display-3').show();
        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.slaughtering-year-display-4').show();
        }
    });  
  ...
  $('.meat-radio').on('change', function () {
        ...
        $('.meat-year-display').hide();
        $('.meat-year-display-2').hide();
        $('.meat-year-display-3').hide();

        var value = $(this).val();

        if (value == 'More than 500 Kg Meat per day') {

            $('.meat-year-display').show();

        } else if (value == 'Upto 500 Kg Meat per day') {

            $('.meat-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.meat-year-display-3').show();
        }
   ...
   /*--------------manufacturer-------------*/
    ...
    $('.manufacturer-radio').on('change', function () {
        ...
        $('.manufacturer-year-display').hide();
        $('.manufacturer-year-display-2').hide();
        $('.manufacturer-year-display-3').hide();
        $('.manufacturer-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Production Capacity: More than 2 MT per day') {

            $('.manufacturer-year-display').show();

        } else if (value == 'Production Capacity: 101 Kgs/Ltrs – 1 MT per Day') {

            $('.manufacturer-year-display-2').show();

        } else if (value == 'Production Capacity: 1MT – 2 MT per Day') {

            $('.manufacturer-year-display-3').show();
        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.manufacturer-year-display-4').show();
        }
   ...
   $('.other-price-66').on('change', function() {
    ...
    $('.Proprietary-radio').on('change', function () {
        $('.Proprietary-year-display').show();
    }); 

    /*price 1 optiona*/
   $('.choose_Proprietary_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Proprietary-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Proprietary-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
    ...
    $('.Novel-radio').on('change', function () {
        $('.Novel-year-display').show();
    }); 

    /*price 1 optiona*/
   $('.choose_Novel_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Novel-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Novel-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
    ...
    $('.warehouse-radio').on('change', function () {
        ...
        $('.warehouse-year-display').hide();
        $('.warehouse-year-display-2').hide();
        $('.warehouse-year-display-3').hide();
        $('.warehouse-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Storage Capacity of More than 10,000 MT') {

            $('.warehouse-year-display').show();

        } else if (value == 'Storage Capacity Upto 10,000 MT') {

            $('.warehouse-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.warehouse-year-display-3').show();
        } 
   ...
   $('.other-price-66').on('change', function() {
    ...
    $('.Atmospheric-radio').on('change', function () {

        $('.Atmospheric-year-display').hide();
        $('.Atmospheric-year-display-2').hide();
        $('.Atmospheric-year-display-3').hide();
        $('.Atmospheric-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Storage Capacity of More than 1,000 MT') {

            $('.Atmospheric-year-display').show();

        } else if (value == 'Storage Capacity Upto 1,000 MT') {

            $('.Atmospheric-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Atmospheric-year-display-3').show();
        } 
   ...
   /*price 1 optiona*/
   $('.choose_Atmospheric_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Atmospheric-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Atmospheric-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
    ...
    $('.Atmospheric-with-radio').on('change', function () {

        $('.Atmospheric-with-year-display').hide();
        $('.Atmospheric-with-year-display-2').hide();
        $('.Atmospheric-with-year-display-3').hide();
        $('.Atmospheric-with-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Storage Capacity of More than 50,000 MT') {

            $('.Atmospheric-with-year-display').show();

        } else if (value == 'Storage Capacity Upto 50,000 MT') {

            $('.Atmospheric-with-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Atmospheric-with-year-display-3').show();
        } 

    });   
   
   /*price 1 optiona*/
   $('.choose_Atmospheric-with_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Atmospheric-with-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Atmospheric-with-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
    ...
    $('.Transporter-radio').on('change', function () {
        ...
        $('.Transporter-year-display').hide();
        $('.Transporter-year-display-2').hide();
        $('.Transporter-year-display-3').hide();
        $('.Transporter-year-display-4').hide();

        var value = $(this).val();

        if (value == 'More than 100 Vehicles and Turnover more than Rs. 30 Crores per annum') {

            $('.Transporter-year-display').show();

        } else if (value == 'Upto 100 Vehicles and Turnover upto Rs. 30 Crores per annum') {

            $('.Transporter-year-display-2').show();

        } else if (value == 'Single Vehicle and Turnover upto Rs.12 Lacs per annum') {

            $('.Transporter-year-display-3').show();
        } 
   ...
   $('.other-price-66').on('change', function() {
    ...
    $('.Wholesaler-radio').on('change', function () {
        ...
        $('.Wholesaler-year-display').hide();
        $('.Wholesaler-year-display-2').hide();
        $('.Wholesaler-year-display-3').hide();
        $('.Wholesaler-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs. 30 Crores per annum') {

            $('.Wholesaler-year-display').show();

        } else if (value == 'Turnover upto Rs. 30 Crores per annum') {

            $('.Wholesaler-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Wholesaler-year-display-3').show();
        } 
   ...
   $('.other-price-66').on('change', function() {
    ...
    $('.Distributor-radio').on('change', function () {
        ...
        $('.Distributor-year-display').hide();
        $('.Distributor-year-display-2').hide();
        $('.Distributor-year-display-3').hide();
        $('.Distributor-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs. 20 Crores per annum') {

            $('.Distributor-year-display').show();

        } else if (value == 'Turnover upto Rs. 20 Crores per annum') {

            $('.Distributor-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Distributor-year-display-3').show();
        } 
   ...
   /*--------------Supplier-------------*/
     ...
     $('.Supplier-radio').on('change', function () {

        $('.Supplier-year-display').hide();
        $('.Supplier-year-display-2').hide();
        $('.Supplier-year-display-3').hide();
        $('.Supplier-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs. 20 Crores per annum') {

            $('.Supplier-year-display').show();

        } else if (value == 'Turnover upto Rs. 20 Crores per annum') {

            $('.Supplier-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Supplier-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Supplier_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Supplier-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Supplier-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
   ...
   /*--------------Retailer-------------*/
     ...
     $('.Retailer-radio').on('change', function () {
        ...
        $('.Retailer-year-display').hide();
        $('.Retailer-year-display-2').hide();
        $('.Retailer-year-display-3').hide();
        $('.Retailer-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs. 20 Crores per annum') {

            $('.Retailer-year-display').show();

        } else if (value == 'Turnover upto Rs. 20 Crores per annum') {

            $('.Retailer-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Retailer-year-display-3').show();
        } 
   ...
   /*--------------Marketer-------------*/
     ...
     $('.Marketer-radio').on('change', function () {

        $('.Marketer-year-display').hide();
        $('.Marketer-year-display-2').hide();
        $('.Marketer-year-display-3').hide();
        $('.Marketer-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs. 20 Crores per annum') {

            $('.Marketer-year-display').show();

        } else if (value == 'Turnover upto Rs. 20 Crores per annum') {

            $('.Marketer-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Marketer-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Marketer_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Marketer-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Marketer-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
   ...
   /*--------------Hotel-------------*/
     ...
     $('.Hotel-radio').on('change', function () {
        ...
        $('.Hotel-year-display').hide();
        $('.Hotel-year-display-2').hide();
        $('.Hotel-year-display-3').hide();
        $('.Hotel-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Five Star and Above') {

            $('.Hotel-year-display').show();

        } else if (value == 'Three Star and Four Star') {

            $('.Hotel-year-display-2').show();

        } else if (value == 'One Star, Two Star or Hotel without Star Rating by Ministry of Tourism (HRACC)') {

            $('.Hotel-year-display-3').show();
        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Hotel-year-display-4').show();
        } 
   ...
   /*--------------Restaurants-------------*/
     ...
     $('.Restaurants-radio').on('change', function () {
        ...
        $('.Restaurants-year-display').hide();
        $('.Restaurants-year-display-2').hide();
        $('.Restaurants-year-display-3').hide();
        $('.Restaurants-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs. 20 Crores per annum') {

            $('.Restaurants-year-display').show();

        } else if (value == 'Turnover upto Rs. 20 Crores per annum') {

            $('.Restaurants-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Restaurants-year-display-3').show();
        } 
   ...
   /*--------------Club-Canteen-------------*/
     ...
     $('.Club-Canteen-radio').on('change', function () {

        $('.Club-Canteen-year-display').hide();
        $('.Club-Canteen-year-display-2').hide();
        $('.Club-Canteen-year-display-3').hide();
        $('.Club-Canteen-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs 12 Lacs per annum') {

            $('.Club-Canteen-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Club-Canteen-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Club-Canteen-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Club-Canteen_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Club-Canteen-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Club-Canteen-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
   ...
   /*--------------Caterar-------------*/
     ...
     $('.Caterar-radio').on('change', function () {
        ...
        $('.Caterar-year-display').hide();
        $('.Caterar-year-display-2').hide();
        $('.Caterar-year-display-3').hide();
        $('.Caterar-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs. 20 Crores per annum') {

            $('.Caterar-year-display').show();

        } else if (value == 'Turnover upto Rs. 20 Crores per annum') {

            $('.Caterar-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Caterar-year-display-3').show();
        } 
   ...
   /*--------------Food-Vending-Agencies-------------*/
     ...
     $('.Food-Vending-Agencies-radio').on('change', function () {

        $('.Food-Vending-Agencies-year-display').hide();
        $('.Food-Vending-Agencies-year-display-2').hide();
        $('.Food-Vending-Agencies-year-display-3').hide();
        $('.Food-Vending-Agencies-year-display-4').hide();

        var value = $(this).val();

        if (value == 'More than 100 Vending Machines and/or located in two or more States/UTs') {

            $('.Food-Vending-Agencies-year-display').show();

        } else if (value == 'Upto 100 Vending Machinesin only one State/UT') {

            $('.Food-Vending-Agencies-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum or Upto 12 Vending Machinesin only one State/UT') {

            $('.Food-Vending-Agencies-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Food-Vending-Agencies_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Food-Vending-Agencies-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Food-Vending-Agencies-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
  ...
  /*--------------Dhaba-------------*/
     ...
     $('.Dhaba-radio').on('change', function () {
        ...
        $('.Dhaba-year-display').hide();
        $('.Dhaba-year-display-2').hide();
        $('.Dhaba-year-display-3').hide();
        $('.Dhaba-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs 12 Lacs per annum') {

            $('.Dhaba-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Dhaba-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Dhaba-year-display-3').show();
        } 
  ...
  /*--------------Importers-------------*/
     ...
     $('.Importers-radio').on('change', function () {

        $('.Importers-year-display').hide();
        $('.Importers-year-display-2').hide();
        $('.Importers-year-display-3').hide();
        $('.Importers-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Importing any type of food product with no limit on the capacity') {

            $('.Importers-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Importers-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Importers-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Importers_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Importers-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Importers-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
  ...
  /*--------------Food-Business-Activities-------------*/
     ...
     $('.Food-Business-Activities-radio').on('change', function () {

        $('.Food-Business-Activities-year-display').hide();
        $('.Food-Business-Activities-year-display-2').hide();
        $('.Food-Business-Activities-year-display-3').hide();
        $('.Food-Business-Activities-year-display-4').hide();

        var value = $(this).val();

        if (value == 'No limit on Capacity or Turnover') {

            $('.Food-Business-Activities-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Food-Business-Activities-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Food-Business-Activities-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Food-Business-Activities_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Food-Business-Activities-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Food-Business-Activities-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
  ...
  /*--------------Departmental-Canteens-------------*/
     ...
     $('.Departmental-Canteens-radio').on('change', function () {

        $('.Departmental-Canteens-year-display').hide();
        $('.Departmental-Canteens-year-display-2').hide();
        $('.Departmental-Canteens-year-display-3').hide();
        $('.Departmental-Canteens-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs 12 Lacs per annum') {

            $('.Departmental-Canteens-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Departmental-Canteens-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Departmental-Canteens-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Departmental-Canteens_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Departmental-Canteens-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Departmental-Canteens-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
  ...
  /*--------------Food-Business-Activities-aiport-------------*/

     $('.Food-Business-Activities-aiport-radio').on('change', function () {

        $('.Food-Business-Activities-aiport-year-display').hide();
        $('.Food-Business-Activities-aiport-year-display-2').hide();
        $('.Food-Business-Activities-aiport-year-display-3').hide();
        $('.Food-Business-Activities-aiport-year-display-4').hide();

        var value = $(this).val();

        if (value == 'No limit on Capacity or Turnover') {

            $('.Food-Business-Activities-aiport-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Food-Business-Activities-aiport-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Food-Business-Activities-aiport-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Food-Business-Activities-aiport_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Food-Business-Activities-aiport-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Food-Business-Activities-aiport-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
...
/*--------------Midday-Meal-------------*/
    ...
    $('.Midday-Meal-radio').on('change', function () {

        $('.Midday-Meal-year-display').hide();
        $('.Midday-Meal-year-display-2').hide();
        $('.Midday-Meal-year-display-3').hide();
        $('.Midday-Meal-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs. 20 Crores per annum') {

            $('.Midday-Meal-year-display').show();

        } else if (value == 'Turnover upto Rs. 20 Crores per annum') {

            $('.Midday-Meal-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Midday-Meal-year-display-3').show();
        } 

    });   
   
   /*price 1 optiona*/
   $('.choose_Midday-Meal_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Midday-Meal-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Midday-Meal-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
   ...
   /*--------------Midday-Meal-Canteen-------------*/
     ...
     $('.Midday-Meal-Canteen-radio').on('change', function () {

        $('.Midday-Meal-Canteen-year-display').hide();
        $('.Midday-Meal-Canteen-year-display-2').hide();
        $('.Midday-Meal-Canteen-year-display-3').hide();
        $('.Midday-Meal-Canteen-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs 12 Lacs per annum') {

            $('.Midday-Meal-Canteen-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Midday-Meal-Canteen-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Midday-Meal-Canteen-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Midday-Meal-Canteen_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Midday-Meal-Canteen-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Midday-Meal-Canteen-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
   ...
   /*--------------Exporter-------------*/
     ...
     $('.Exporter-radio').on('change', function () {

        $('.Exporter-year-display').hide();
        $('.Exporter-year-display-2').hide();
        $('.Exporter-year-display-3').hide();
        $('.Exporter-year-display-4').hide();

        var value = $(this).val();

        if (value == 'No limit on Capacity or Turnover') {

            $('.Exporter-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Exporter-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Exporter-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Exporter_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Exporter-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Exporter-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
   ...
   /*--------------Midday-Meal-Canteen-------------*/
     ...
     $('.multiple-type-radio').on('change', function () {

        $('.multiple-type-year-display').hide();
        $('.multiple-type-year-display-2').hide();
        $('.multiple-type-year-display-3').hide();
        $('.multiple-type-year-display-4').hide();

        var value = $(this).val();

        if (value == 'Turnovermore than Rs 12 Lacs per annum') {

            $('.multiple-type-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.multiple-type-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.multiple-type-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_multiple-type_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-multiple-type-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-multiple-type-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
   ...
   /*--------------E-commerce-------------*/
     ...
     $('.E-commerce-radio').on('change', function () {

        $('.E-commerce-year-display').hide();
        $('.E-commerce-year-display-2').hide();
        $('.E-commerce-year-display-3').hide();
        $('.E-commerce-year-display-4').hide();

        var value = $(this).val();

        if (value == 'No limit on Capacity or Turnover') {

            $('.E-commerce-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.E-commerce-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.E-commerce-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_E-commerce_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-E-commerce-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-E-commerce-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
   ...
   /*--------------Head-Office-------------*/
     ...
     $('.Head-Office-radio').on('change', function () {

        $('.Head-Office-year-display').hide();
        $('.Head-Office-year-display-2').hide();
        $('.Head-Office-year-display-3').hide();
        $('.Head-Office-year-display-4').hide();

        var value = $(this).val();

        if (value == 'No limit on Capacity or Turnover') {

            $('.Head-Office-year-display').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Head-Office-year-display-2').show();

        } else if (value == 'Turnover upto Rs. 12 Lacs per annum') {

            $('.Head-Office-year-display-3').show();
        } 

    });  

    /*price 1 optiona*/
   $('.choose_Head-Office_value').on('change', function() {
       var selectedOption = $(this).find('option:selected');
       var dataprice = selectedOption.data('price');
       $('.option-Head-Office-price').text(dataprice);
       $('.payable-price').val(dataprice);
   });
   ...
   $('.other-price-66').on('change', function() {
       var checkedData = $('.other-price-66:checked').data('price');
       $('.option-Head-Office-price-2').text(checkedData);
       $('.payable-price').val(checkedData);
   });
