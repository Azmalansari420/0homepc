...
class Orders extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Orders',
						   	'table_name'=>'orders',
						   	'upload_path'=>'media/uploads/orders/',
						   	'load_path'=>'admin/orders/',
						   	'redirect_path'=>'admin_con/orders/',
						   	'back_url'=>'orders',
						   	'add_url'=>'orders',
						   	'edit_url'=>'orders',
						   	'delete_url'=>'orders',
						   	'view_url'=>'orders',
						   	'table_url'=>'admin/orders/table',
						   	'status_value'=>'orders',
						   	'multiple_delete'=>'admin_con/orders/delete_all',
						   	'pagination_url'=>'admin_con/orders/get_table_data',
						   	'controller_name'=>'orders',
						   	'page_name'=>'orders.php',
						   	'pagination_limit'=>'15',
						   	'formURL'=>'admin_con/orders/UpdateData',
						   	'excellink'=>'admin_con/orders/download_excel',
						   ); 
   ...
   //--check user login or not
	...
	public function get_table_data() 
	{
	    ...
	    if ($user_id !== null && $user_id !== '' && $user_id != '--Select user_id --') {
