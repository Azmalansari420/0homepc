...
class Category extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'load_path'=>'admin/category/',
						   	'redirect_path'=>'admin_con/category/',
						   	'back_url'=>'category',
						   	'add_url'=>'category',
						   	'edit_url'=>'category',
						   	'delete_url'=>'category',
						   	'view_url'=>'category',
						   	'table_url'=>'admin/category/table',
						   	'status_value'=>'category',
						   	'multiple_delete'=>'admin_con/category/delete_all',
						   	'pagination_url'=>'admin_con/category/get_table_data',
						   	'controller_name'=>'category',
						   	'page_name'=>'services-list.php',
						   	'pagination_limit'=>'15',
						   	'formURL'=>'admin_con/category/UpdateData',
						   	'excellink'=>'admin_con/category/download_excel',
						   ); 
    ...
    function UpdateData()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			if($_FILES['banner']['name']!='')
			{
				...
				$insertdata['banner'] = $bbanner;
			}
			else
			{
				$insertdata['banner'] = $this->input->post('oldbanner');
			}
