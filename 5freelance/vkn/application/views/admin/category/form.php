               ...
               <div class="col-lg-4">
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-12 form-group">
                           <label>Click to Upload Banner</label>
                           <input type="file" id="image-input" class="form-control" name="banner">

                           <!-- Single Image Preview -->
                           <img id="image-preview" 
                                src="<?= !empty($EDITDATA->banner) ? base_url($upload_path . $EDITDATA->banner) : '' ?>" 
                                alt="Image Preview" 
                                width="100px" 
                                style="<?= !empty($EDITDATA->banner) ? '' : 'display:none;' ?>">

                           <!-- Hidden input to keep old banner -->
                           <input type="hidden" class="form-control" name="oldbanner" value="<?= @$EDITDATA->banner; ?>">
                        </div>
