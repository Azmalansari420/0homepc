...
$menu = [
    ...
    ["id"=>3,"title"=>"Category","url"=>"admin_con/category/listing","icon"=>"fa fa-cog bg-black text-white","sub"=>[]],
    // ["id"=>3,"title"=>"Sub Category","url"=>"admin_con/sub_categories/listing","icon"=>"fa fa-cog bg-black text-white","sub"=>[]],
    ["id"=>3,"title"=>"Services","url"=>"admin_con/services/listing","icon"=>"fa fa-cog bg-black text-white","sub"=>[]],
    ["id"=>3,"title"=>"Portfolio","url"=>"admin_con/portfolio/listing","icon"=>"fa fa-cog bg-black text-white","sub"=>[]],

    ["id"=>4,"title"=>"Testimonials","url"=>"admin_con/testimonials/listing","icon"=>"fa fa-cog bg-black text-white","sub"=>[]],
    ["id"=>4,"title"=>"Partner","url"=>"admin_con/partner/listing","icon"=>"fa fa-cog bg-black text-white","sub"=>[]],
