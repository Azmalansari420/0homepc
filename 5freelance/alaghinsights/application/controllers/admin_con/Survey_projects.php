...
class Survey_projects extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Survey Projects',
						   	'table_name'=>'survey_projects',
						   	'upload_path'=>'media/uploads/survey_projects/',
						   	'load_path'=>'admin/survey_projects/',
						   	'redirect_path'=>'admin_con/survey_projects/',
						   	'back_url'=>'survey_projects',
						   	'add_url'=>'survey_projects',
						   	'edit_url'=>'survey_projects',
						   	'delete_url'=>'survey_projects',
						   	'view_url'=>'survey_projects',
						   	'table_url'=>'admin/survey_projects/table',
						   	'status_value'=>'survey_projects',
						   	'multiple_delete'=>'admin_con/survey_projects/delete_all',
						   	'pagination_url'=>'admin_con/survey_projects/get_table_data',
						   	'controller_name'=>'survey_projects',
						   	'page_name'=>'survey_projects.php',
						   	'pagination_limit'=>'15',
						   	'formURL'=>'admin_con/survey_projects/UpdateData',
						   	'excellink'=>'admin_con/survey_projects/download_excel',
						   ); 
...
function UpdateData()
{
    if(isset($_POST['submit']))
    {
        ...
        if(empty($id))
		{
		    $project_code = generate_project_code($this);
		}
		else
		{
        ...
        if(empty($id))
        {
            $insertdata["created_at"] = $getdatetime;
        ...
        {
            $insertdata["updated_at"] = $getdatetime;
