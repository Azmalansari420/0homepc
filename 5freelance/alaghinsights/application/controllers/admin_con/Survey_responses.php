...
class Survey_responses extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'upload_path'=>'media/uploads/survey_responses/',
						   	'load_path'=>'admin/survey_responses/',
						   	'redirect_path'=>'admin_con/survey_responses/',
						   	'back_url'=>'survey_responses',
						   	'add_url'=>'survey_responses',
						   	'edit_url'=>'survey_responses',
						   	'delete_url'=>'survey_responses',
						   	'view_url'=>'survey_responses',
						   	'table_url'=>'admin/survey_responses/table',
						   	'status_value'=>'survey_responses',
						   	'multiple_delete'=>'admin_con/survey_responses/delete_all',
						   	'pagination_url'=>'admin_con/survey_responses/get_table_data',
						   	'controller_name'=>'survey_responses',
						   	'page_name'=>'survey_responses.php',
						   	'pagination_limit'=>'15',
						   	'formURL'=>'admin_con/survey_responses/UpdateData',
						   	'excellink'=>'admin_con/survey_responses/download_excel',
						   ); 
   ...
   //--check user login or not
    ...
    function UpdateData()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			{
			    $insertdata['image'] = $this->input->post('oldimage');
			}
	...
	public function get_table_data() 
	{
		...
		$this->db->or_like('status_name', $search);
		$this->db->group_end();
