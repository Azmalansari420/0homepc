...
//----database
if($_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']== '192.168.1.19'){
// if($_SERVER['HTTP_HOST']=='localhost'){
define("dbuser", "root");
define("dbpassword", "");
define("dbname", "alaghinsights");
}
else{
define("dbuser", "u346521377_alaghinsights");
define("dbpassword", "Azmal@@786[];");
define("dbname", "u346521377_alaghinsights");
}
